...
$get_web_leads = $Form_model->findAll();
...
<div class="row justify-content-center"> 
 ...
 <?php if($get_web_leads != null) { ?>
    <?php foreach($get_web_leads as $r) { ?>
    <div class="col-lg-4 col-md-6">
        ...
        <div class="card-body pt-0">
            ...
            <div class="row align-items-end">
                ...
                <?php if(in_array('web_lead_3',staff_role_resource()) || in_array('web_lead_4',staff_role_resource()) || $user_info['user_type'] == 'super_user') { ?>
                <div class="dropdown"> <a class="drp-icon dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal"></i></a>
                    ...
                    <?php if(in_array('web_lead_3',staff_role_resource()) || $user_info['user_type'] == 'super_user') { ?>
                        <a class="dropdown-item" href="<?= site_url('erp/view-client-info').'/'.uencode($r['id']);?>"><i class="feather icon-eye"></i>
                    <?= lang('Main.xin_view');?>
                    </a> 
                    <?php } ?>
                    <?php if(in_array('web_lead_4',staff_role_resource()) || $user_info['user_type'] == 'super_user') { ?>
            ...
            <p class="mb-3 text-muted">@<?= $r['name'];?>
            </p>
            <p class="mb-1"><b>
                <?= lang('Main.xin_email');?>
